...
public class TornadoTaskSchedule implements AbstractTaskGraph {
    ...
    public void updateReference(Object oldRef, Object newRef) {
        ...
        // 3. Update from executionContext
    ...
    public void flinkInfoInner(FlinkData finfo) {
        executionContext.setFinfo(finfo);
    }

    @Override
    public void flinkCompInfoInner(FlinkCompilerInfo fcomp) {
        new FlinkCompilerInfoIntermediate(fcomp);
    ...
    private void rewriteTaskForReduceSkeleton(MetaReduceCodeAnalysis analysisTaskSchedule) {
        ...
        reduceTaskScheduleMeta.setFlinkData(this.executionContext.getFinfo());
